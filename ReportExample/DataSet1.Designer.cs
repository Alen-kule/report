...
namespace ReportExample {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DataTable1Row AddDataTable1Row(string InvoiceNumber, string ChargeName, float Rate, decimal Units, decimal Amount, decimal Tax, decimal t, string Contract, string CompanyName, System.DateTime StartDate, System.DateTime EndDate, System.DateTime InvoiceDate) {
            ...
            private void InitClass() {
                ...
                this.columnInvoiceNumber.MaxLength = 256;
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public string ChargeName {
                get {
                    try {
                        return ((string)(this[this.tableDataTable1.ChargeNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ChargeName\' in table \'DataTable1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable1.ChargeNameColumn] = value;
                }
            }
            ...
            public float Rate {
                get {
                    return ((float)(this[this.tableDataTable1.RateColumn]));
                }
                set {
            ...
            public decimal t {
                get {
                    try {
                        return ((decimal)(this[this.tableDataTable1.tColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsChargeNameNull() {
                return this.IsNull(this.tableDataTable1.ChargeNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetChargeNameNull() {
                this[this.tableDataTable1.ChargeNameColumn] = global::System.Convert.DBNull;
            }
...
namespace ReportExample.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Invoices.InvoiceNumber, SifCharges.ChargeName, InvoiceDetails_1.Rate,
 CAST(Units as decimal(18,0)) AS Units, 
						 CAST(Units *  Rate as decimal(18,2)) AS Amount, 
						 CAST(Tax as  decimal(16,2)) AS Tax, 
                             (SELECT        CAST(SUM(Units * Rate) + SUM(Tax) AS decimal(18, 2)) AS Expr1
                               FROM            InvoiceDetails
                               WHERE        (InvoiceId = Invoices.Id)) AS t, Clients.Contract, Clients.CompanyName, CAST(Invoices.StartDate AS date) AS StartDate, CAST(Invoices.EndDate AS date) AS EndDate, CAST(Invoices.InvoiceDate AS date) 
                         AS InvoiceDate
FROM            Invoices INNER JOIN
                         InvoiceDetails AS InvoiceDetails_1 ON Invoices.Id = InvoiceDetails_1.InvoiceId INNER JOIN
                         SifCharges ON InvoiceDetails_1.ChargeId = SifCharges.Id INNER JOIN
                         Clients ON Invoices.CompanyName = Clients.CompanyName
WHERE        (Invoices.InvoiceNumber = @invoice)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@invoice", global::System.Data.SqlDbType.NVarChar, 256, global::System.Data.ParameterDirection.Input, 0, 0, "InvoiceNumber", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.DataTable1DataTable dataTable, string invoice) {
        ...
        public virtual DataSet1.DataTable1DataTable GetData(string invoice) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((invoice == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
